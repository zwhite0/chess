...
public class InGameUI {
    ...
    public ChessPiece.PieceType getPromotionType(ChessPosition startingPosition, int endingRow){
        ChessPiece.PieceType promotion = null;
        if (chessGame.getBoard().getPiece(startingPosition).getPieceType().equals(ChessPiece.PieceType.PAWN) &&
                this.teamColor.equalsIgnoreCase("white")&&endingRow == 8 ||
                chessGame.getBoard().getPiece(startingPosition).getPieceType().equals(ChessPiece.PieceType.PAWN) &&
